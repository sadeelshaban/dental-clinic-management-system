...
- [ ] **Phase 6:** Attachments (upload endpoint, storage, size/type limits, metadata)
- [ ] **Phase 7:** Reports & dashboard (daily/monthly summaries, month-over-month comparison, outstanding receivables, patient directory)
